...
public final class QueryUtlisHome {
    ...
    public static ArrayList<Home> featchrecipedata(String requestUrl) throws JSONException {
        ...
        ArrayList<Home> tennis = extractFeatureFromJson(jsonResponse);//,jsonResponse2);
    ...
    public static ArrayList<Home> extractFeatureFromJson(String tennisjson) throws JSONException {
