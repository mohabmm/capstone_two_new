...
public final class QueryUtlisRankingWomen {
    ...
    public static ArrayList<RankingWomen> featchrecipedata(String requestUrl) throws JSONException {
        ...
        ArrayList<RankingWomen> moha = extractFeatureFromJson(jsonResponse);//,jsonResponse2);
    ...
    private static ArrayList<RankingWomen> extractFeatureFromJson(String tennisjson) throws JSONException {
